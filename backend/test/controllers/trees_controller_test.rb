...
class TreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tree" do
    assert_difference('Tree.count') do
      post trees_url, params: { tree: { height: @tree.height, name: @tree.name, tree_type: @tree.tree_type } }, as: :json
    end
  ...
  test "should update tree" do
    patch tree_url(@tree), params: { tree: { height: @tree.height, name: @tree.name, tree_type: @tree.tree_type } }, as: :json
    assert_response 200
  end
